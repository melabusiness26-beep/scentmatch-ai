...
// Neue Nischen: Schmuck, Kaffee, Yoga, Grill, Velo, Winter, Geschenke, Kreativ
PRODUCTS.push(
  {
    slug: "edelstahl-halsketten-set",
    name: "Wasserfestes Edelstahl-Halsketten-Set (18K vergoldet)",
    niche: "schmuck-accessoires",
    emoji: "💛",
    short: "Der «Waterproof Jewelry»-Trend: Schmuck, der Duschen und Sport übersteht.",
    description:
      "Ein Layering-Set aus 2–3 vergoldeten Edelstahl-Ketten (316L). Wasserfester Schmuck ist DER Schmuck-Trend – er löst das grösste Problem billiger Ketten (Anlaufen) und rechtfertigt Premium-Preise.",
    trend: "Im Trend",
    score: 84,
    buyPriceChf: [3, 8],
    sellPriceChf: [25, 49],
    deliveryDays: "Nihaojewelry 8–15 Tage · AliExpress 10–20 Tage · CJ 6–14 Tage",
    suppliers: ["nihaojewelry", "aliexpress", "cj-dropshipping"],
    pros: [
      "Marge 4–6× – Schmuck ist die margenstärkste Einsteiger-Nische",
      "Federleicht: Versand als Brief möglich (Porto-Vorteil!)",
      "«Wasserfest»-Beweisvideos sind der perfekte Content-Winkel",
    ],
    cons: [
      "Nur echtes 316L-Edelstahl verkaufen – Legierungen laufen an und ruinieren Bewertungen",
      "Hübsche Verpackung ist Pflicht (Schmuck wird verschenkt)",
    ],
    qualityChecks: [
      "2-Wochen-Trage-Test: Duschen, Sport, Parfüm – läuft nichts an, färbt nichts ab?",
      "Materialnachweis 316L / nickelfrei schriftlich geben lassen (Nickel-Allergie!)",
      "Verschlüsse 50× öffnen/schliessen, Kettenglieder auf scharfe Kanten prüfen",
    ],
    videoIdea:
      "Kette unter dem Wasserhahn, im See, beim Sport – Text: «Tag 14. Immer noch wie neu.» Der Beweis IST die Werbung.",
    season: "Ganzjährig, Peaks Weihnachten & Valentinstag",
    targetAudience: "Frauen 16–45, Geschenkkäufer (Partner!)",
  },
  {
    slug: "personalisierte-namenskette",
    name: "Personalisierte Namenskette",
    niche: "schmuck-accessoires",
    emoji: "✨",
    short: "Der Geschenk-Klassiker mit eigenem Namen – Premium-Preis dank Personalisierung.",
    description:
      "Eine Kette mit individuellem Namen in geschwungener Schrift, gefertigt auf Bestellung. Personalisierung hebt dich von jedem Massen-Anbieter ab und macht CHF 39–59 zum fairen Preis.",
    trend: "Dauerbrenner",
    score: 81,
    buyPriceChf: [8, 15],
    sellPriceChf: [39, 59],
    deliveryDays: "CJ (POD) 8–15 Tage – Produktion + Versand; Fristen vor Feiertagen anschreiben!",
    suppliers: ["cj-dropshipping", "aliexpress"],
    pros: [
      "Personalisierung = kaum Preisvergleich möglich, hohe Marge",
      "Perfektes Geschenk (Geburtstag, Muttertag, Geburt – planbare Peaks)",
      "Beschenkte posten es stolz → Gratis-Werbung",
    ],
    cons: [
      "Vom Umtausch ausgeschlossen (personalisiert) – klar kommunizieren",
      "Produktionszeit addiert sich zur Lieferzeit – ehrlich anschreiben",
      "Schreibfehler-Risiko: Bestell-Feld mit Kontroll-Schritt einbauen",
    ],
    qualityChecks: [
      "Muster mit langem Namen + Umlauten (z. B. «Séraphine», «Müller») bestellen!",
      "Materialqualität wie beim Ketten-Set prüfen (Anlauf-Test)",
      "Schrift-Lesbarkeit und Verarbeitung der Ränder kontrollieren",
    ],
    videoIdea:
      "Reaktions-Video: Freundin packt Kette mit ihrem Namen aus, Hand vor dem Mund. Text: «Das beste Geschenk ist persönlich.»",
    season: "Ganzjährig, Peaks Weihnachten, Valentinstag, Muttertag",
    targetAudience: "Geschenkkäufer:innen 18–60",
  },
  {
    slug: "pour-over-kaffeeset",
    name: "Pour-Over-Kaffeeset (Dripper + Glaskanne)",
    niche: "kaffee-tee",
    emoji: "☕",
    short: "Handaufguss-Ritual für die Home-Café-Community – Ästhetik inklusive.",
    description:
      "Ein Set aus Keramik-/Edelstahl-Dripper und Borosilikat-Glaskanne für den Handaufguss. Das Ritual ist der Content: langsames Eingiessen, Dampf, Ästhetik – Slow-Living pur.",
    trend: "Im Trend",
    score: 77,
    buyPriceChf: [8, 14],
    sellPriceChf: [32, 49],
    ...
    suppliers: ["aliexpress", "cj-dropshipping", "bigbuy"],
    pros: [
      "Kaffee-Nation Schweiz + Home-Café-Trend = grosse, kaufkräftige Zielgruppe",
      "Set-Charakter mit gutem Warenkorb",
      "Ästhetischer Content produziert sich fast von selbst",
    ],
    cons: [
      "Glas = Bruchrisiko im Versand (Verpackung prüfen!)",
      "Borosilikat-/LFGB-Nachweis nötig (heisses Wasser)",
    ],
    qualityChecks: [
      "Kochend-Wasser-Test der Kanne (Borosilikat hält das aus, Billigglas nicht)",
      "Muster-Versand: kommt das Glas heil an? 2–3 Bestellungen testen",
      "Tropfverhalten des Drippers real prüfen",
    ],
    videoIdea:
      "Zeitlupe: kreisendes Eingiessen, Dampf im Morgenlicht, erster Schluck. Text: «7 Minuten nur für dich.»",
    season: "Ganzjährig, Peak Herbst/Winter",
    targetAudience: "Kaffee-Fans 20–45, Geschenk für Geniesser",
  },
  {
    slug: "glas-teekanne-mit-sieb",
    name: "Glas-Teekanne mit Edelstahl-Sieb",
    niche: "kaffee-tee",
    emoji: "🫖",
    short: "Blühender Tee im Glas – das Produkt, das sich selbst inszeniert.",
    description:
      "Eine hitzefeste Glaskanne mit herausnehmbarem Sieb. Mit blühendem Tee oder Früchtetee im Glas entsteht das Video von allein – und die Tee-Community wächst parallel zur Kaffee-Welle.",
    trend: "Dauerbrenner",
    score: 74,
    buyPriceChf: [7, 12],
    sellPriceChf: [29, 45],
    ...
    suppliers: ["aliexpress", "cj-dropshipping", "bigbuy"],
    pros: [
      "Visuell starkes Produkt (Teeblüten!) mit Geschenk-Charakter",
      "Zweite Zielgruppe: Wellness/Achtsamkeits-Community",
      "Ganzjährig, Peak in der kalten Jahreszeit",
    ],
    cons: ["Glas-Bruchrisiko im Versand", "KEINEN Tee mitverkaufen (Lebensmittel-Regeln) – nur die Kanne"],
    qualityChecks: [
      "Kochend-Wasser-Test + Temperaturschock (kalt/heiss)",
      "Sieb: Feinheit und rostfreie Qualität prüfen",
      "Deckel-Passform und Ausgiess-Verhalten (tropft es?)",
    ],
    videoIdea:
      "Zeitraffer: Teeblüte öffnet sich im Glas. Text: «Schöner als jede Kerze.» ASMR-版 mit Giessgeräusch.",
    season: "Ganzjährig, Peak Herbst/Winter",
    targetAudience: "Tee- & Wellness-Fans 25–60",
  },
  {
    slug: "rutschfeste-yogamatte",
    name: "Rutschfeste Yogamatte mit Tragegurt",
    niche: "yoga-achtsamkeit",
    emoji: "🧘",
    short: "Das Kernprodukt jeder Yoga-Praxis – Qualität entscheidet über alles.",
    description:
      "Eine TPE- oder Kork-Matte mit Ausrichtungslinien und Tragegurt. Die Community wechselt Matten regelmässig und bewertet gnadenlos ehrlich – wer hier Qualität liefert, gewinnt treue Kundschaft.",
    trend: "Im Trend",
    score: 76,
    buyPriceChf: [12, 20],
    sellPriceChf: [45, 69],
    ...
    suppliers: ["aliexpress", "cj-dropshipping", "bigbuy"],
    pros: [
      "Hoher Warenkorb (CHF 45–69)",
      "Grosse, engagierte Community mit Wiederkauf",
      "Kork-Variante bedient auch die Nachhaltigkeits-Zielgruppe",
    ],
    cons: [
      "Grösser/schwerer im Versand (Rolle)",
      "Rutschfestigkeit ist DAS Kriterium – Billigmatten fallen durch",
    ],
    qualityChecks: [
      "Rutsch-Test mit feuchten Händen (Downward Dog!) – kompromisslos",
      "Geruchstest: TPE darf nicht chemisch riechen",
      "Dicke nachmessen, Ausrichtungslinien-Druckqualität prüfen",
    ],
    videoIdea:
      "Ehrlicher Test: alte rutschige Matte vs. neue im direkten Vergleich, schwitzige Hände. Die Community liebt ehrliche Matten-Tests.",
    season: "Ganzjährig, Peak Januar",
    targetAudience: "Yoga-Praktizierende 25–55",
  },
  {
    slug: "meditationskissen",
    name: "Meditationskissen (Bio-Baumwolle)",
    niche: "yoga-achtsamkeit",
    emoji: "🪷",
    short: "Der Ruhe-Anker fürs Zuhause – Achtsamkeit wird zum Einrichtungstrend.",
    description:
      "Ein rundes Sitzkissen (Zafu) mit abnehmbarem Bezug. Meditation wächst über Apps in den Alltag – das Kissen ist das erste physische Produkt, das sich diese Zielgruppe kauft.",
    trend: "Kommender Trend",
    score: 73,
    buyPriceChf: [10, 16],
    sellPriceChf: [39, 59],
    ...
    suppliers: ["aliexpress", "cj-dropshipping"],
    pros: [
      "Wachsender Achtsamkeits-Markt mit wenig CH-Konkurrenz",
      "Schöner Deko-Faktor = auch Home-Living-Kundschaft",
      "Guter Warenkorb, Bundle mit Matte naheliegend",
    ],
    cons: ["Volumen im Versand (komprimiert verschicken lassen)", "Füllung (Buchweizen/Kapok) muss deklariert sein"],
    qualityChecks: [
      "Probesitzen: 20 Minuten – hält die Füllung die Form?",
      "Bezug: Reissverschluss + Waschbarkeit testen",
      "Materialnachweis (Bio-Baumwolle) anfordern, Nähte prüfen",
    ],
    videoIdea:
      "«Meine 10 Minuten Ruhe am Morgen»-Ästhetik: Kissen, Kerze, Fensterlicht. Ruhiger Content für eine laute Welt.",
    season: "Ganzjährig, Peak Januar & Herbst",
    targetAudience: "Meditations-Einsteiger & Yogis 25–55",
  },
  {
    slug: "grillmatten-set",
    name: "Antihaft-Grillmatten (3er-Set)",
    niche: "grill-bbq",
    emoji: "🍖",
    short: "Nichts fällt mehr durch den Rost – der Grill-Hack für Gemüse & Fisch.",
    description:
      "Wiederverwendbare Antihaft-Matten für den Grillrost: Gemüse, Fisch und Käse grillieren, ohne dass etwas durchfällt oder klebt. Demo-Video erklärt den Nutzen in 5 Sekunden.",
    trend: "Dauerbrenner",
    score: 75,
    buyPriceChf: [4, 8],
    sellPriceChf: [19, 32],
    ...
    suppliers: ["aliexpress", "cj-dropshipping", "bigbuy"],
    pros: [
      "Löst ein bekanntes Grill-Problem (Gemüse fällt durch!)",
      "Flach & leicht: Brief-Versand möglich",
      "Wiederverwendbar = Nachhaltigkeits-Bonus",
    ],
    cons: [
      "Lebensmittelkontakt + Hitze: LFGB-Zertifikat ist Pflicht, nicht Kür",
      "Temperatur-Obergrenze ehrlich angeben",
    ],
    qualityChecks: [
      "LFGB-/FDA-Zertifikat anfordern (PFOA-frei)",
      "Realer Grill-Test: klebt wirklich nichts? Reinigung einfach?",
      "Nach 5 Anwendungen: Beschichtung intakt?",
    ],
    videoIdea:
      "Split: Spargel fällt durch den Rost (Drama) vs. perfekt auf der Matte. Text: «Der Trick, den dir kein Grill-Papi verrät.»",
    season: "Frühling/Sommer, Peak Vatertag",
    targetAudience: "Grill-Fans & Familien 25–60",
  },
  {
    slug: "digitales-grillthermometer",
    name: "Digitales Grillthermometer (2 Fühler)",
    niche: "grill-bbq",
    emoji: "🌡️",
    short: "Nie mehr trockenes Fleisch – das Gadget, das Grill-Ehre rettet.",
    description:
      "Ein Thermometer mit zwei Fühlern und Ziel-Temperatur-Alarm. Verwandelt Grill-Raten in Grill-Wissen – und ist DAS Geschenk für den Grill-Fan, der schon alles hat.",
    trend: "Im Trend",
    score: 76,
    buyPriceChf: [8, 15],
    sellPriceChf: [35, 55],
    ...
    suppliers: ["aliexpress", "cj-dropshipping"],
    pros: [
      "Klarer Nutzen mit Emotion (niemand will Gäste enttäuschen)",
      "Hoher Warenkorb, top Geschenk-Produkt",
      "Ganzjahres-Nutzen (Backofen!) gegen die Grill-Saisonalität",
    ],
    cons: ["Messgenauigkeit ist alles – Billigmodelle scheitern hier", "Elektronik: Batterien/CE prüfen"],
    qualityChecks: [
      "Eiswasser- (0 °C) und Kochwasser-Test (100 °C auf ~430 m: ~98.5 °C!) – Abweichung max. ±1–2 °C",
      "Kabel-Fühler hitzefest? Display draussen lesbar?",
      "Alarm-Funktion und Reichweite testen, CE bestätigen",
    ],
    videoIdea:
      "Steak-Anschnitt perfekt rosa, Thermometer im Bild. Text: «Raten war gestern.» Vorher-Version: verkohltes Steak (Humor).",
    season: "Frühling–Herbst + Weihnachtsgeschäft",
    targetAudience: "Grill- & Kochbegeisterte 25–60 (Geschenk!)",
  },
  {
    slug: "led-velolicht-set",
    name: "USB-LED-Velolicht-Set (vorne + hinten)",
    niche: "velo-ebike",
    emoji: "🚴",
    short: "Sichtbarkeit auf dem Arbeitsweg – Pflichtkauf für jede Pendlerin.",
    description:
      "Ein wiederaufladbares Licht-Set mit Schnellspann-Halterung. In der dunklen Jahreshälfte ein Sicherheits-Pflichtkauf – und dank USB-Ladung dem Batterie-Licht klar überlegen.",
    trend: "Dauerbrenner",
    score: 78,
    buyPriceChf: [6, 12],
    sellPriceChf: [25, 42],
    ...
    suppliers: ["aliexpress", "cj-dropshipping"],
    pros: [
      "Echtes Sicherheitsbedürfnis + gesetzliche Lichtpflicht",
      "Herbst-Peak planbar (Zeitumstellung!)",
      "Klein, leicht, gute Marge",
    ],
    cons: [
      "Vorschriften beachten: keine Blinkmodi vorne bewerben (in CH nicht erlaubt für Hauptlicht) – ehrlich informieren",
      "Akkulaufzeit-Angaben oft geschönt – selbst messen",
    ],
    qualityChecks: [
      "Leuchtdauer auf allen Stufen messen",
      "Halterungs-Test auf Kopfsteinpflaster (verrutscht nichts?)",
      "Regentest (IP-Angabe), USB-C bevorzugen, CE bestätigen",
    ],
    videoIdea:
      "POV Heimweg im Dunkeln: kaum sichtbar → Licht-Set an, Weg leuchtet. Text: «Deine Familie will, dass man dich sieht.»",
    season: "Ganzjährig, Peak Oktober (Zeitumstellung)",
    targetAudience: "Velo-Pendler:innen 20–60",
  },
  {
    slug: "velo-rahmentasche",
    name: "Wasserdichte Velo-Rahmentasche (Handy-Fenster)",
    niche: "velo-ebike",
    emoji: "🚵",
    short: "Handy, Schlüssel, Snack – alles griffbereit am Rahmen, auch bei Regen.",
    description:
      "Eine Rahmentasche mit durchsichtigem Touch-Fenster fürs Handy (Navigation!) und wasserdichtem Verschluss. Für Velotouren und E-Bike-Ausflüge fast schon Standard-Ausrüstung.",
    trend: "Im Trend",
    score: 74,
    buyPriceChf: [7, 12],
    sellPriceChf: [29, 45],
    ...
    suppliers: ["aliexpress", "cj-dropshipping"],
    pros: [
      "E-Bike-Boom bringt laufend neue Käufer:innen",
      "Navigation am Velo = Alltagsnutzen, nicht nur Sport",
      "Bundle mit Licht-Set naheliegend",
    ],
    cons: ["Touch durch Folie muss wirklich funktionieren", "Passform an verschiedenen Rahmen testen"],
    qualityChecks: [
      "Touch-Test durchs Fenster (auch mit Navigations-App)",
      "Brause-Test: 10 Minuten «Regen» – bleibt innen alles trocken?",
      "Klett/Halterung auf ruppiger Fahrt prüfen",
    ],
    videoIdea:
      "Tour-POV: Navigation läuft im Sichtfeld, Regenschauer kommt, alles bleibt trocken. Text: «Die Schweiz per Velo – vorbereitet.»",
    season: "Frühling–Herbst",
    targetAudience: "Velofahrer & E-Biker 20–65",
  },
  {
    slug: "schuhspikes",
    name: "Schuhspikes / Schuhkrallen gegen Eisglätte",
    niche: "winter-schnee",
    emoji: "🧊",
    short: "Sicher über vereiste Trottoirs – der Winter-Problemlöser Nr. 1.",
    description:
      "Aufziehbare Spikes für normale Schuhe – in Sekunden montiert, sicherer Halt auf Eis. Für ältere Menschen, Hundebesitzer und Winterwanderer ein sofort verständlicher Kauf.",
    trend: "Dauerbrenner",
    score: 77,
    buyPriceChf: [4, 9],
    sellPriceChf: [19, 35],
    deliveryDays: "AliExpress 10–20 Tage · CJ 6–14 Tage · BigBuy 3–7 Tage (für die Saison wichtig!)",
    suppliers: ["aliexpress", "cj-dropshipping", "bigbuy"],
    pros: [
      "Beim ersten Eis explodiert die Nachfrage planbar",
      "Drei Zielgruppen: Senioren (Geschenk der Kinder!), Hundebesitzer, Wanderer",
      "Klein und leicht im Versand",
    ],
    cons: [
      "Nur Nov–März verkaufbar – rechtzeitig (Sept/Okt) vorbereiten",
      "Grössenangaben (S–XL) sauber übersetzen, sonst Retouren",
    ],
    qualityChecks: [
      "Gummi-Kältetest: Gefrierfach über Nacht, dann dehnen – wird er spröde?",
      "Spikes: Anzahl, Material (Edelstahl?) und Halt auf Eis real testen",
      "An verschiedenen Schuhgrössen an-/ausziehen",
    ],
    videoIdea:
      "Vereiste Rampe: normaler Schuh rutscht (gestellt!), mit Spikes sicherer Tritt. Text: «Schick das deinen Eltern.»",
    season: "November–März",
    targetAudience: "Senioren-Angehörige, Hundebesitzer, Winterwanderer",
  },
  {
    slug: "frostschutz-scheibenabdeckung",
    name: "Frostschutz-Scheibenabdeckung fürs Auto",
    niche: "winter-schnee",
    emoji: "🚙",
    short: "Abdeckung wegziehen statt 10 Minuten kratzen – jeder Wintermorgen ein Verkaufsargument.",
    description:
      "Eine magnetisch fixierte Abdeckung für die Frontscheibe: abends drauf, morgens frostfrei losfahren. Jede:r Autofahrer:in kennt den Schmerz – das Produkt verkauft der Wintermorgen selbst.",
    trend: "Dauerbrenner",
    score: 75,
    buyPriceChf: [5, 10],
    sellPriceChf: [22, 35],
    ...
    suppliers: ["aliexpress", "cj-dropshipping", "bigbuy"],
    pros: [
      "Universelles Winter-Problem, sofort verständlich",
      "Zeitersparnis-Argument (10 Min./Morgen) rechnet sich selbst",
      "Flach und leicht im Versand",
    ],
    cons: ["Passform je Automodell – Grössen klar angeben", "Befestigung muss Wind standhalten"],
    qualityChecks: [
      "Frost-Nacht-Test am eigenen/geliehenen Auto",
      "Windtest: hält die Befestigung (Magnete/Laschen in der Tür)?",
      "Material bei Kälte biegsam? Grösse für gängige Modelle prüfen",
    ],
    videoIdea:
      "Split-Screen 7:00 Uhr: Nachbar kratzt (Frust) vs. du ziehst die Abdeckung weg und fährst los. Text: «10 Minuten mehr Schlaf. Jeden Tag.»",
    season: "Oktober–März",
    targetAudience: "Autofahrer:innen ohne Garage 25–65",
  },
  {
    slug: "foto-mondlampe",
    name: "Personalisierte Foto-Mondlampe",
    niche: "geschenke-personalisiert",
    emoji: "🌙",
    short: "Ein Foto wird zur leuchtenden Mondkugel – der Emotions-Bestseller.",
    description:
      "Eine 3D-gedruckte Mondlampe, in die ein eigenes Foto eingearbeitet wird – beim Einschalten erscheint das Bild im warmen Licht. Einer der stärksten personalisierten Geschenk-Seller überhaupt.",
    trend: "Im Trend",
    score: 79,
    buyPriceChf: [12, 20],
    sellPriceChf: [49, 79],
    deliveryDays: "CJ (POD) 10–18 Tage inkl. Produktion – Feiertags-Fristen gross anschreiben!",
    suppliers: ["cj-dropshipping"],
    pros: [
      "Sehr hoher Warenkorb (CHF 49–79) und Wow-Effekt",
      "Emotionale Reaktions-Videos = stärkster Content überhaupt",
      "Kein Preisvergleich möglich (individuell)",
    ],
    cons: [
      "Foto-Qualität der Kundschaft schwankt – Upload-Hinweise nötig",
      "Produktionszeit + Umtausch-Ausschluss klar kommunizieren",
    ],
    qualityChecks: [
      "Muster mit eigenem Foto: Erkennbarkeit, Licht-Qualität, Verarbeitung",
      "USB-Ladung und Farbmodi testen, CE bestätigen",
      "Verpackung: kommt die Kugel heil an?",
    ],
    videoIdea:
      "Reaktion: Grossmutter packt Lampe aus, Enkelfoto leuchtet auf, Tränen. Ehrlich gefilmt schlägt dieses Video jede Hochglanz-Werbung.",
    season: "Ganzjährig, Peaks Weihnachten & Muttertag",
    targetAudience: "Geschenkkäufer:innen 20–60 (Familie, Paare)",
  },
  {
    slug: "personalisierte-fototasse",
    name: "Personalisierte Foto-/Spruch-Tasse",
    niche: "geschenke-personalisiert",
    emoji: "☕",
    short: "Das Einsteiger-Produkt im Personalisieren – einfach, beliebt, bewährt.",
    description:
      "Eine Keramiktasse mit eigenem Foto, Namen oder Spruch, produziert per Print-on-Demand in der EU. Das perfekte erste POD-Produkt: unkompliziert, planbar, immer gefragt.",
    trend: "Dauerbrenner",
    score: 73,
    buyPriceChf: [8, 12],
    sellPriceChf: [25, 39],
    deliveryDays: "Printful/Printify 5–10 Tage (EU-Produktion)",
    suppliers: ["printful"],
    pros: [
      "EU-Produktion = schnelle Lieferung & gute Druckqualität",
      "Einfachster Einstieg in personalisierte Produkte",
      "Planbare Geschenk-Peaks (Weihnachten, Muttertag, Bürowichteln)",
    ],
    cons: ["Kleinere Marge als China-Sourcing", "Design/Vorlagen müssen gut aussehen (Canva hilft)"],
    qualityChecks: [
      "Muster drucken: Farben, Randschärfe, Spülmaschinen-Test",
      "Umlaute und lange Namen auf der Vorlage testen",
      "Verpackung: Bruchsicherheit prüfen",
    ],
    videoIdea:
      "Morgens im Büro: Tasse mit Insider-Spruch des Teams, Kollegin lacht. Text: «Das Wichtel-Geschenk, das wirklich ankommt.»",
    season: "Ganzjährig, Peak Q4",
    targetAudience: "Geschenkkäufer:innen 20–60, Büro-Teams",
  },
  {
    slug: "malen-nach-zahlen-set",
    name: "Malen-nach-Zahlen-Set (Erwachsene)",
    niche: "kreativ-diy",
    emoji: "🎨",
    short: "Der Anti-Stress-Klassiker – Feierabend-Entspannung ohne Bildschirm.",
    description:
      "Komplett-Set mit nummerierter Leinwand, Farben und Pinseln. Einer der bewährtesten Dropshipping-Seller überhaupt: entspannend, verschenkbar, und der Zeitraffer vom entstehenden Bild ist Content-Gold.",
    trend: "Dauerbrenner",
    score: 80,
    buyPriceChf: [5, 10],
    sellPriceChf: [25, 39],
    deliveryDays: "AliExpress 10–20 Tage · CJ 6–14 Tage (eigene Motive möglich!)",
    suppliers: ["aliexpress", "cj-dropshipping"],
    pros: [
      "Bewährter Bestseller mit stabiler Nachfrage",
      "Digital-Detox-Trend als Rückenwind",
      "Personalisierbar (eigenes Foto als Motiv via CJ) = Premium-Variante",
    ],
    cons: [
      "Motive müssen lizenzfrei sein (Urheberrecht!)",
      "Fehlende Farben = sichere Reklamation – Vollständigkeit prüfen",
    ],
    qualityChecks: [
      "Ein Set selbst anfangen: Nummern lesbar? Farben deckend? Material vollständig?",
      "Leinwand-Qualität (vorgespannt vs. gerollt) klären",
      "Pinsel-Qualität prüfen (haaren sie?)",
    ],
    videoIdea:
      "14-Tage-Zeitraffer vom weissen Feld zum fertigen Bild + stolzes Aufhängen. Text: «Mein Feierabend gehört wieder mir.»",
    season: "Ganzjährig, Peak Herbst/Winter",
    targetAudience: "Frauen 25–65, Geschenk für Kreative",
  },
  {
    slug: "diamond-painting-set",
    name: "Diamond-Painting-Set",
    niche: "kreativ-diy",
    emoji: "💎",
    short: "Funkelnde Steinchen setzen – das ASMR-Hobby mit Suchtfaktor.",
    description:
      "Ein Set mit Klebe-Leinwand, funkelnden Steinchen und Werkzeug. Die Community ist riesig und treu (Wiederkäufe!), und das Steinchen-Setzen liefert perfekten ASMR-Content.",
    trend: "Im Trend",
    score: 76,
    buyPriceChf: [4, 9],
    sellPriceChf: [22, 35],
    ...
    suppliers: ["aliexpress", "cj-dropshipping"],
    pros: [
      "Treue Community mit hoher Wiederkaufrate",
      "ASMR-/Satisfying-Content funktioniert verlässlich",
      "Günstiger Einkauf, gutes Bundle-Potenzial (Zubehör, Rahmen)",
    ],
    cons: ["Kleinteile: nichts für Haushalte mit Kleinkindern (Hinweis!)", "Steinchen-Fehlmengen = Reklamationsrisiko"],
    qualityChecks: [
      "Set selbst testen: Klebkraft der Leinwand, Steinchen-Passform",
      "Vollständigkeit und Beschriftung der Tütchen prüfen",
      "Motiv-Lizenzfreiheit beim Lieferanten klären",
    ],
    videoIdea:
      "Nahaufnahme + Sound: Steinchen klicken ins Raster, Kamera zieht auf: halbfertiges Funkel-Bild. ASMR pur.",
    season: "Ganzjährig, Peak Herbst/Winter",
    targetAudience: "Kreativ-Community 25–65, Geschenkkäufer",
  }
);
...
export const SEARCH_TERMS: Record<string, string> = {
  ...
  "edelstahl-halsketten-set": "waterproof 18k gold plated stainless steel necklace set",
  "personalisierte-namenskette": "custom name necklace personalized",
  "pour-over-kaffeeset": "pour over coffee dripper set glass",
  "glas-teekanne-mit-sieb": "glass teapot stainless steel infuser",
  "rutschfeste-yogamatte": "non slip yoga mat alignment lines strap",
  meditationskissen: "meditation cushion zafu buckwheat",
  "grillmatten-set": "bbq grill mat non stick set",
  "digitales-grillthermometer": "digital meat thermometer dual probe",
  "led-velolicht-set": "usb rechargeable bike light set",
  "velo-rahmentasche": "waterproof bike frame bag phone holder",
  schuhspikes: "ice cleats shoe spikes crampons",
  "frostschutz-scheibenabdeckung": "car windshield frost cover magnetic",
  "foto-mondlampe": "custom photo moon lamp 3d",
  "personalisierte-fototasse": "custom photo mug personalized",
  "malen-nach-zahlen-set": "paint by numbers adults kit",
  "diamond-painting-set": "diamond painting kit full drill",
};
