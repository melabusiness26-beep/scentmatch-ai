...
export const metadata: Metadata = {
  title: 'Alle Düfte – die Vaelo-Duftdatenbank',
  description:
    'Stöbere durch die kuratierte Vaelo-Duftdatenbank: über 160 Düfte von Bestsellern bis zu seltenen Nischenperlen – suchbar nach Name, Marke, Note, Geschlecht und Anlass.',
  alternates: { canonical: '/duefte' },
  openGraph: {
    title: 'Alle Düfte | Vaelo',
