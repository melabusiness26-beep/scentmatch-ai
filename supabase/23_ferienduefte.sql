...
values
  ((select id from public.brands where name='Tom Ford'),       'Soleil Blanc',           'tom-ford-soleil-blanc',      'Unisex', 'gourmand', 190, 7, 7, 88, 'Sommer', 'Abend',  ARRAY['Bergamotte','Kardamom','Pistazie'], ARRAY['Kokosnuss','Tuberose','Ylang-Ylang','Jasmin'], ARRAY['Amber','Tonkabohne','Benzoe']),
  ...
  ((select id from public.brands where name='Sol de Janeiro'), 'Cheirosa 39',            'sol-de-janeiro-cheirosa-39', 'Women',  'gourmand', 35,  5, 5, 83, 'Sommer', 'Alltag', ARRAY['Kokosnuss'], ARRAY['Tropische Orchidee','Praline'], ARRAY['Vanille','Moschus']),
