...
values
  ...
  ((select id from public.brands where name='Dior'),              'Miss Dior',               'miss-dior',                    'Women',  'floral',   120, 7,  7, 88, 'Frühling',      'Date',   ARRAY['Blutorange','Mandarine'], ARRAY['Grasse-Rose','Pfingstrose'], ARRAY['Rosenholz','Moschus']),
