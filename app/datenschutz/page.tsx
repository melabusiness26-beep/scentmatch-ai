...
export const metadata: Metadata = {
  ...
  description: 'Wie Vaelo mit deinen Daten umgeht – transparent und einfach erklärt.',
    ...
    <main>
      ...
      <div className="container">
        <section className="detail-hero">
          <div>
            ...
            <p className="lead">
              ...
              Daten beim Besuch von Vaelo anfallen.
            </p>
          </div>
        </section>
        ...
        <section className="section legal">
          ...
          <h2>2. Grundsatz</h2>
          <p>
            Vaelo ist eine reine Informations- und Empfehlungsplattform. Du kannst die Website nutzen,
